...
<html>
<head>
<title>TRBS | TRAVEL RESERVATION AND BOOKING SYSTEM</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Travel Reservation and Booking System In PHP" />
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TRBS - TRAVEL RESERVATION AND BOOKING SYSTEM</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
